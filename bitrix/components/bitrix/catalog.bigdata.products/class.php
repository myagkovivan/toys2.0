...
class CatalogBigdataProductsComponent extends CSaleBestsellersComponent
{
	...
	protected function extractDataFromCache()
	{
		...
		return !($this->StartResultCache(false, $this->getAdditionalCacheId(), '/'.SITE_ID.'/bitrix/catalog.bigdata.products/common'));
	}
		...
		if (!$showByIds)
		{
			...
			try
			{
				if (!$this->extractDataFromCache())
				{
					...
					{
						$this->clearResultCache($this->getAdditionalCacheId(), '/'.SITE_ID.'/bitrix/catalog.bigdata.products/common');
					}
