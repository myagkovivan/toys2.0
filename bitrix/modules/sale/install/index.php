...
Class sale extends CModule
{
	...
	function InstallDB()
	{
		...
		{
			$orderInitialStatus = OrderStatus::getInitialStatus();
			$orderFinalStatus   = OrderStatus::getFinalStatus();
			$deliveryInitialStatus = DeliveryStatus::getInitialStatus();
			$deliveryFinalStatus   = DeliveryStatus::getFinalStatus();
