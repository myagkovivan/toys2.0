...
//	const EVENT_COMPATIBILITY_ON_BASKET_ = "OnSaleCancelOrder";
	...
	public static function registerEvents()
	{
		...
		$eventManager->registerEventHandler('sale', 'OnSaleBasketItemSaved', 'sale', '\Bitrix\Sale\Compatible\EventCompatibility', 'onBasketItemChange');
	...
	public static function unRegisterEvents()
	{
		...
		$eventManager->unRegisterEventHandler('sale', 'OnSaleBasketItemSaved', 'sale', '\Bitrix\Sale\Compatible\EventCompatibility', 'onBasketItemChange');
	}
