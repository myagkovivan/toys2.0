		...
		case "ajax_recount_prices":
			if (strlen($_POST["currency"])>0)
			{
				...
				if ($_POST["sumDiffDiscountPrice"])
					$arPices["formatDiscDiffSum"] =  Loc::getMessage("CATALOG_SET_DISCOUNT_DIFF", array("#PRICE#" => CCurrencyLang::CurrencyFormat($_POST["sumDiffDiscountPrice"], $_POST["currency"], true)));
